...
def train_net(cfg):
    ...
    Model = import_module(args.net_model)  # 在当前目录下找 model.py
    # print(Model)    # <module 'model' from '/home/ps/wcw_1999/codes/seedformer-master/codes/model.py'> 
    # quit()
    model = Model.__dict__[args.arch_model](up_factors=cfg.NETWORK.UPSAMPLE_FACTORS)   # args.arch_model = seedformer_dim128 seedformer_dim128 在 model.py 中
    ...
    # Start training
    manager.train(model, train_data_loader, val_data_loader, cfg)   # 输入：model, train data, val data, cfg 
